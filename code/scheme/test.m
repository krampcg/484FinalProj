...
% Sea-Level
data_plot_1 = plot(x,u_lw_p(1,:), '-b','Linewidth',2.0);
hold on
% Formatting
axis([x(1), x(end), 0, 1.1])
hT = title('Lax-Wendroff Wave Simulation, t = 0');
set(hT, 'FontSize', 18);
hX = xlabel('x');
set(hX, 'FontSize', 14);
hY = ylabel('u(x)');
...
% Sea-Level
data_plot_2 = plot(x,u_lw_p(75,:), '-b','Linewidth',2.0);
hold on
% Formatting
axis([x(1), x(end), 0, 1.1])
hT = title('Lax-Wendroff Wave Simulation, t = 0.15');
set(hT, 'FontSize', 18);
hX = xlabel('x');
set(hX, 'FontSize', 14);
hY = ylabel('u(x)');
...
% Sea-Level
data_plot_2 = plot(x,u_lw_p(150,:), '-b','Linewidth',2.0);
hold on
% Formatting
axis([x(1), x(end), 0, 1.1])
hT = title('Lax-Wendroff Wave Simulation, t = 0.25');
set(hT, 'FontSize', 18);
hX = xlabel('x');
set(hX, 'FontSize', 14);
hY = ylabel('u(x)');
